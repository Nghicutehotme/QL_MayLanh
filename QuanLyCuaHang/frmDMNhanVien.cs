...
namespace QuanLyCuaHang
{
    public partial class frmDMNhanVien : Form
    {
        ...
        private void btn_xoa_Click_1(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE NhanVien WHERE MaNhanVien=N'" + txt_manhanvien.Text + "'";
        ...
        private void btn_luu_Click_1(object sender, EventArgs e)
        {
            ...
            if (chk_gioitinh.Checked == true)
                ...
                gt = "Nữ";
            sql = "select MaNhanVien from NhanVien where MaNhanVien=N'" + txt_manhanvien.Text.Trim() + "'";
            ...
            sql = "insert into NhanVien(MaNhanVien,TenNhanVien,GioiTinh, DiaChi,DienThoai, NgaySinh) VALUES (N'" + txt_manhanvien.Text.Trim() + "',N'" + txt_tennhanvien.Text.Trim() + "',N'" + gt + "',N'" + txt_diachi.Text.Trim() + "','" + mask_dienthoai.Text + "','" + dtp_ngaysinh.Value.ToString("yyyy-MM-dd") + "')";
            Functions.RunSQL(sql);
            loadDataGridview();
            Reset();
            btn_xoa.Enabled = true;
        ...
        private void btn_sua_Click_1(object sender, EventArgs e)
        {
            ...
            if (chk_gioitinh.Checked == true)
                ...
                gt = "Nữ";
            // cập nhật lại record
            sql = "update NhanVien set  TenNhanVien=N'" + txt_tennhanvien.Text.Trim().ToString() +
