...
namespace QuanLyCuaHang
{
    public partial class frmTimHDBan : Form
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            HDBan = Functions.GetDataTable(sql);
            if (HDBan.Rows.Count == 0)
            {
                MessageBox.Show("Không có bản ghi thỏa mãn điều kiện!!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
                MessageBox.Show("Có " + HDBan.Rows.Count + " bản ghi thỏa mãn điều kiện!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            dgvTKHoaDon.DataSource = HDBan;
            LoadDataGridView();
        }
