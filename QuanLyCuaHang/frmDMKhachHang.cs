...
namespace QuanLyCuaHang
{
    public partial class frmDMKhachHang : Form
    {
        ...
        private void btn_luu_Click(object sender, EventArgs e)
        {
            ...
            sql = "select MaKhach from KhachHang where MaKhach=N'" + txt_makhach.Text.Trim() + "'";
            ...
            //Chèn thêm
            sql = "insert into KhachHang values (N'" + txt_makhach.Text.Trim() +
                "',N'" + txt_tenkhach.Text.Trim() + "',N'" + txt_diachi.Text.Trim() + "','" + mask_dienthoai.Text + "')";
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            ...
            sql = "update KhachHang set TenKhach=N'" + txt_tenkhach.Text.Trim().ToString() + "',DiaChi=N'" +
        ...
        private void btn_xoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE KhachHang WHERE MaKhach=N'" + txt_makhach.Text + "'";
                Functions.RunSQL(sql);
                LoadDataGridView();
                Reset();
            }
