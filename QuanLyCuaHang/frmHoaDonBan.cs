...
namespace QuanLyCuaHang
{
    public partial class frmHoaDonBan : Form
    {
        ...
        private void frmHoaDonBan_Load(object sender, EventArgs e)
        {
            ...
            txt_giamgia.Text = "0";
            txt_tongtien.Text = "0";
            Functions.fillCombo("SELECT MaKhach, TenKhach FROM KhachHang", cbo_makhachhang, "MaKhach", "TenKhach");
            cbo_makhachhang.SelectedIndex = -1;
            Functions.fillCombo("SELECT MaNhanVien, TenNhanVien FROM NhanVien", cbo_manhanvien, "MaNhanVien", "TenNhanVien");
            cbo_manhanvien.SelectedIndex = -1;
            Functions.fillCombo("SELECT MaHang, TenHang FROM HangHoa", cbo_mahang, "MaHang", "TenHang");
        ...
        {
            string sql;
            sql = "SELECT a.MaHang, b.TenHang, a.SoLuong, b.DonGiaBan, a.GiaGiam, a.ThanhTien FROM ChiTietHDBan AS a, HangHoa AS b WHERE a.MaHDBan = N'" + txt_mahoadon.Text + "' AND a.MaHang=b.MaHang";
            DataTable tblCTHDB = Functions.GetDataTable(sql);
        ...
        {
            string str;
            str = "SELECT NgayBan FROM HDBan WHERE MaHDBan = N'" + txt_mahoadon.Text + "'";
            dtp_ngayban.Value = DateTime.Parse(Functions.GetFieldValues(str));
            str = "SELECT MaNhanVien FROM HDBan WHERE MaHDBan = N'" + txt_mahoadon.Text + "'";
            cbo_manhanvien.SelectedValue = Functions.GetFieldValues(str);
            str = "SELECT MaKhach FROM HDBan WHERE MaHDBan = N'" + txt_mahoadon.Text + "'";
            cbo_makhachhang.SelectedValue = Functions.GetFieldValues(str);
            str = "SELECT TongTien FROM HDBan WHERE MaHDBan = N'" + txt_mahoadon.Text + "'";
        ...
        {   
            ...
            ResetValues();
            txt_mahoadon.Text = Functions.CreateKey("HD");
            LoadDataGridView();
        }
        ...
        private void btn_luu_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT MaHDBan FROM HDBan WHERE MaHDBan=N'" + txt_mahoadon.Text + "'";
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO HDBan(MaHDBan, MaNhanVien, NgayBan, MaKhach, TongTien) VALUES (N'" + txt_mahoadon.Text.Trim() + "', N'" + cbo_manhanvien.SelectedValue + "','" + dtp_ngayban.Value + "',N'" + cbo_makhachhang.SelectedValue + "'," + txt_tongtien.Text + ")";
            ...
            sql = "SELECT MaHang FROM ChiTietHDBan WHERE MaHang=N'" + cbo_mahang.SelectedValue + "' AND MaHDBan = N'" + txt_mahoadon.Text.Trim() + "'";
            if (Functions.CheckKey(sql))
            {
            ...
            sl = Convert.ToDouble(Functions.GetFieldValues("SELECT SoLuong FROM HangHoa WHERE MaHang = N'" + cbo_mahang.SelectedValue + "'"));
            ...
            sql = "INSERT INTO ChiTietHDBan(MaHDBan,MaHang,SoLuong,DonGia,GiaGiam,ThanhTien) VALUES(N'" + txt_mahoadon.Text.Trim() + "',N'" + cbo_mahang.SelectedValue + "'," + txt_soluong.Text + "," + txt_dongia.Text + "," + txt_giamgia.Text + "," + txt_thanhtien.Text + ")";
            Functions.RunSQL(sql);
            LoadDataGridView();
            // Cập nhật lại số lượng của mặt hàng vào bảng HangHoa
            SLcon = sl - Convert.ToDouble(txt_soluong.Text);
            sql = "UPDATE HangHoa SET SoLuong =" + SLcon + " WHERE MaHang= N'" + cbo_mahang.SelectedValue + "'";
            Functions.RunSQL(sql);
            // Cập nhật lại tổng tiền cho hóa đơn bán
            tong = Convert.ToDouble(Functions.GetFieldValues("SELECT TongTien FROM HDBan WHERE MaHDBan = N'" + txt_mahoadon.Text + "'"));
            Tongmoi = tong + Convert.ToDouble(txt_thanhtien.Text);
            sql = "UPDATE HDBan SET TongTien =" + Tongmoi + " WHERE MaHDBan = N'" + txt_mahoadon.Text + "'";
            Functions.RunSQL(sql);
        ...
        private void cbo_mahang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            str = "SELECT TenHang FROM HangHoa WHERE MaHang =N'" + cbo_mahang.SelectedValue + "'";
           txt_tenhang.Text = Functions.GetFieldValues(str);
            str = "SELECT DonGiaBan FROM HangHoa WHERE MaHang =N'" + cbo_mahang.SelectedValue + "'";
        ...
        private void cbo_makhachhang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            str = "Select TenKhach from KhachHang where MaKhach = N'" + cbo_makhachhang.SelectedValue + "'";
            txt_tenkhach.Text = Functions.GetFieldValues(str);
            str = "Select DiaChi from KhachHang where MaKhach = N'" + cbo_makhachhang.SelectedValue + "'";
            txt_diachi.Text = Functions.GetFieldValues(str);
            str = "Select DienThoai from KhachHang where MaKhach= N'" + cbo_makhachhang.SelectedValue + "'";
        ...
        private void cbo_manhanvien_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            str = "Select TenNhanVien from NhanVien where MaNhanVien =N'" + cbo_manhanvien.SelectedValue + "'";
            txt_tennhanvien.Text = Functions.GetFieldValues(str);
        }

        private void cbo_mahoadon_DropDown(object sender, EventArgs e)
        {
            Functions.fillCombo("SELECT MaHDBan FROM HDBan", cbo_mahoadon, "MaHDBan", "MaHDBan");
        ...
        private void btn_xoa_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "SELECT MaHang,SoLuong FROM ChiTietHDBan WHERE MaHDBan = N'" + txt_mahoadon.Text + "'";
                DataTable HangHoa = Functions.GetDataTable(sql);
                for (int hang = 0; hang <= HangHoa.Rows.Count - 1; hang++)
                {
                    // Cập nhật lại số lượng cho các mặt hàng
                    sl = Convert.ToDouble(Functions.GetFieldValues("SELECT SoLuong FROM HangHoa WHERE MaHang = N'" + HangHoa.Rows[hang][0].ToString() + "'"));
                    slxoa = Convert.ToDouble(HangHoa.Rows[hang][1].ToString());
                    slcon = sl + slxoa;
                    sql = "UPDATE HangHoa SET SoLuong =" + slcon + " WHERE MaHang= N'" + HangHoa.Rows[hang][0].ToString() + "'";
                    Functions.RunSQL(sql);
                }

                //Xóa chi tiết hóa đơn
                sql = "DELETE ChiTietHDBan WHERE MaHDBan=N'" + txt_mahoadon.Text + "'";
                Functions.RunSQL(sql);

                //Xóa hóa đơn
                sql = "DELETE HDBan WHERE MaHDBan=N'" + txt_mahoadon.Text + "'";
                Functions.RunSQL(sql);
                ResetValues();
                LoadDataGridView();
                btn_xoa.Enabled = false;
        ...
        private void btn_in_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Cửa hàng bán máy lạnh";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Tân Phú - TP.HCM";
            ...
            sql = "SELECT a.MaHDBan, a.NgayBan, a.TongTien, b.TenKhach, b.DiaChi, b.DienThoai, c.TenNhanVien FROM HDBan AS a, KhachHang AS b, NhanVien AS c WHERE a.MaHDBan = N'" + txt_mahoadon.Text + "' AND a.MaKhach = b.MaKhach AND a.MaNhanVien = c.MaNhanVien";
            ...
            sql = "SELECT b.TenHang, a.SoLuong, b.DonGiaBan, a.GiaGiam, a.ThanhTien " +
        ...
        private void dgvHDBanHang_DoubleClick(object sender, EventArgs e)
        {
            ...
            if ((MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes))
            {
                ...
                sql = "DELETE ChiTietHDBan WHERE MaHDBan=N'" + txt_mahoadon.Text + "' AND MaHang = '" + MaHangxoa + "'";
                Functions.RunSQL(sql);
                // Cập nhật lại số lượng cho các mặt hàng
                ...
                Functions.RunSQL(sql);
                // Cập nhật lại tổng tiền cho hóa đơn bán
                tong = Convert.ToDouble(Functions.GetFieldValues("SELECT TongTien FROM HDBan WHERE MaHDBan = '" + txt_mahoadon.Text + "'"));
                tongmoi = tong - ThanhTienxoa;
                sql = "UPDATE HDBan SET TongTien =" + tongmoi + " WHERE MaHDBan = '" + txt_mahoadon.Text + "'";
                Functions.RunSQL(sql);
                txt_tongtien.Text = tongmoi.ToString();
                lbl_bangchu.Text = "Bằng chữ: " + Functions.ChuyenSoSangChuoi(double.Parse(tongmoi.ToString()));
                LoadDataGridView();
